...
# The island is partitioned into a grid of square cells. You are given an m x n integer heights
...
# north, south, east, and west if the neighboring cell's height is less than or equal to the current
